...
class TestActivity:
    ...
    def test_phone_number_validation(self):
        ...
        for phone in valid_phones:
            ...
            assert len(activity.phone_number.replace('+', '').replace(' ', '').replace('-', '').replace('(', '').replace(')', '')) >= 10
...
class TestSMSMessage:
    ...
    def test_is_activity_message_property(self):
        ...
        for message in activity_messages:
            ...
            assert sms.is_activity_message, f"'{message}' should be recognized as activity"
        ...
        for message in non_activity_messages:
            ...
            assert not sms.is_activity_message, f"'{message}' should not be recognized as activity"
