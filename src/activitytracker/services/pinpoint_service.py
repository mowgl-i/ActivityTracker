...
class PinpointService:
        ...
        try:
            ...
            if phone_result.get("StatusCode") == 200:
                return {
                    ...
                    "status_message": phone_result.get(
    ...
    def send_activity_confirmation(
        self, phone_number: str, activity_id: str, activity_type: str, description: str
    ) -> Dict[str, Any]:
        """
    ...
    def send_parsing_error(
        self, phone_number: str, original_message: str, suggestions: List[str]
    ) -> Dict[str, Any]:
        """
    ...
    def get_sms_channel_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "promotional_messages_per_second": sms_channel.get(
                    "PromotionalMessagesPerSecond"
                ),
                "transactional_messages_per_second": sms_channel.get(
